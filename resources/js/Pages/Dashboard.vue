...
<template>
    ...
    <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
        ...
        <h2 class="text-sm font-medium text-gray-900">Pinned Trainings</h2>
        ...
        <div class="inline-block min-w-full border-b border-gray-200 align-middle">
            ...
            <thead>
                ...
                <th class="border-b border-gray-200 bg-gray-50 px-6 py-3 text-left text-sm font-semibold text-gray-900" scope="col">
                    <span class="lg:pl-2">Trainings</span>
                </th>
                <th class="border-b border-gray-200 bg-gray-50 px-6 py-3 text-left text-sm font-semibold text-gray-900" scope="col">Facilitator</th>
