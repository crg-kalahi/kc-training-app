    ...
    <div>
      ...
      <div ref="certificateRef" class="max-w-4xl mx-auto p-8 border border-gray-300 shadow-lg bg-white relative font-serif no-select mt-30">
        ...
        <div class="text-left mt-4 space-y-2 ml-40 mb-5">
          ...
          <h2 class="text-5xl text-red-600 font-bold font-monotype">Dioame Jade C. Rendon</h2>
          <p class="text-sm max-w-2xl mx-auto">
            for having successfully participated during the <b>{TRAINING}</b>.
            held on {DATE} at <br> {VENUE}. <br><br> Given this <b>3rd day of January 2025</b>.
          </p>
        </div>
