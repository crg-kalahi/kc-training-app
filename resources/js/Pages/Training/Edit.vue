...
import FilesRepository from './EditComponents/FilesRepository.vue';
import { ArrowUpRightIcon } from '@heroicons/vue/24/outline';
export default {
    props: ["training", "training_id_selected", "attachments", "users", "listTraining", "listLearning", "listKeyResourcePerson"],
    methods: {
        moment,
    },
    data() {
